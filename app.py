...
with st.form("boq_form"):
    ...
    with col1:
        kabel_12 = st.number_input("Panjang Kabel 12 Core (meter)", min_value=0.0, value=, key="kabel_12")
    with col2:
        kabel_24 = st.number_input("Panjang Kabel 24 Core (meter)", min_value=0.0, value=, key="kabel_24")
